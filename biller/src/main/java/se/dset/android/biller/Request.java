 ...
 * {@link se.dset.android.biller.util.Constants#BILLING_RESPONSE_RESULT_OK}. The {@link #onFailure(int)}
...
public abstract class Request {
     ...
     * the IAB request. Return {@link se.dset.android.biller.util.Constants#BILLING_RESPONSE_RESULT_OK}
     * on success and anything else to signal failure.
     * @param service Service object to be used to fulfill the request.
     * @return {@link se.dset.android.biller.util.Constants#BILLING_RESPONSE_RESULT_OK} on success.
     ...
     * returns {@link se.dset.android.biller.util.Constants#BILLING_RESPONSE_RESULT_OK}.
     */
    protected abstract void onSuccess();

    /**
     * Called on the main thread if {@link #runBackground(com.android.vending.billing.IInAppBillingService)}
     * returns something other than {@link se.dset.android.biller.util.Constants#BILLING_RESPONSE_RESULT_OK}.
